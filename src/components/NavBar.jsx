    ...
    <header className="min-w-[100px]">
        <div className="flex bg-amazonclone text-white h-[60px]">
            ...
            <div className="flex m-4">
                ...
                <div className="pr-4 pl-4 relative items-center">
                ...
                <div className="pr-4 pl-4 relative items-center">
                    ...
                    <div className="text-sm xl:text-base font-bold">& Order</div>
                </div>
                <Link to={"/checkout"}>
                    <div className='flex pr-3 pl-3 relative items-center'>
                        <ShoppingCartIcon className="h-[48px]" />
                        <div className="relative">
                            <div className=" relative [9px] font-bold m-2   text-orange-400 ">
                                {cart}
                            </div>
                        </div>
